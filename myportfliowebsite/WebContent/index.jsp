...
<%@page errorPage="messagebox/errorpage.jsp" isELIgnored="false"%>
...
-->
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-light">
        <div class="container">
            <a class="navbar-brand" href="index.jsp"><i class='uil uil-user'></i> Marvel</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a href="#signup" class="nav-link"><span data-hover="Signup">SignUp</span></a>
                    </li>
                </ul>
	...
	<!-- get the session and print the value -->
	<% 
                ...
                <div class="col-lg-7 col-md-12 col-12 d-flex align-items-center">
                    <div class="about-text">
                        ...
                        <h1 class="animated animated-text">
                            <span class="mr-2">Hey Clients, I'm</span>
                        ...
                        <div class="custom-btn-group mt-4">
                          ...
                          <button  class='uil uil-file-alt'>Download</button>
                          </form>
                ...
                <div class="col-lg-6 col-12">
                  <h2 class="mb-4">Experiences</h2>
                    ...
                    <sql:setDataSource
   					...
   					<sql:query dataSource="${con}" var="rs">select * from myportfolio.exp</sql:query>
                ...
                <div class="col-lg-6 col-12">
                  <h2 class="mb-4 mobile-mt-2">Educations</h2>
                    ...
                    <div class="timeline">
   					...
   					<sql:query dataSource="${con}" var="rs">select * from myportfolio.edu</sql:query>
        ...
        <div class="row">
          ...
          <div class="col-lg-5 mr-lg-5 col-12">
            <div class="google-map w-100">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3717.044794018058!2d76.23220134043025!3d21.309246283521738!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd832c2cd1a56e5%3A0xdefb747cb4058dc1!2sShahi%20Qila!5e0!3m2!1sen!2sin!4v1673420749880!5m2!1sen!2sin" width="400" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
